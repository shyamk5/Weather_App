...
<title>SkyWeather App</title>
</head>
<body>

	<div class="mainContainer">
     <form action="weather-forecast" method="post" class="searchInput">
            <input type="text" placeholder="Enter City Name" id="searchInput" value="${city}" name="inputCity"/>
